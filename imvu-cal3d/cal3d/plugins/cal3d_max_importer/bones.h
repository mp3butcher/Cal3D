// This file taken from the Max 5.1 "samples/objects" directory as bones.cpp.
...
//Added by AF (12/01/2000) to support the BoneObject filter in schematic view
SvGraphNodeReference BoneObj::SvTraverseAnimGraph(IGraphObjectManager *gom, Animatable *owner, int id, DWORD flags)
	{

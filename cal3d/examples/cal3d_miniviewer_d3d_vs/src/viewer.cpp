...
/*
The vertex shader has been generated by this hlsl code:
	...
	)
{
	...
	for(int j=0;j<4;j++)
	{
	   ...
	   pos += mul(Bones[i], tempPos) * IN.Weight[j];
	   
	   float3x3 m;
	   m[0].xyz = Bones[i][0].xyz;
	   m[1].xyz = Bones[i][1].xyz;
	   m[2].xyz = Bones[i][2].xyz;
	   
	   normal += mul(m, IN.Normal)* IN.Weight[j];
	}
...
"mul r8, r1, c94.x                   \n"\
"mov a0.x, r8.x                      \n"\
"m3x3 r3.xyz, v3, c7[a0.x]           \n"\
"mul r10.xyz, r3, v1.x               \n"\
"mov a0.x, r8.y                      \n"\
"m3x3 r5.xyz, v3, c7[a0.x]           \n"\
"mad r7.xyz, r5, v1.y, r10           \n"\
"mov a0.x, r8.z                      \n"\
"m3x3 r2.xyz, v3, c7[a0.x]           \n"\
"mad r4.xyz, r2, v1.z, r7            \n"\
"mov a0.x, r8.w                      \n"\
"m3x3 r11.xyz, v3, c7[a0.x]          \n"\
"mad r1.xyz, r11, v1.w, r4           \n"\
"dp3 r1.w, r1, r1                    \n"\
"rsq r1.w, r1.w                      \n"\
"mul r3.xyz, r1, r1.w                \n"\
"dp3 r10.w, r3, c4                   \n"\
"max r5.w, r10.w, c94.y              \n"\
"add r0, r5.w, c6                    \n"\
"mul oD0, r0, c5                     \n"\
"mov r7.w, c94.w                     \n"\
"mov r2.xyz, v0                      \n"\
"mov r2.w, c94.w                     \n"\
"mov a0.x, r8.x                      \n"\
"m4x3 r9.xyz, r2, c7[a0.x]           \n"\
"mul r4.xyz, r9, v1.x                \n"\
"mov a0.x, r8.y                      \n"\
"m4x3 r11.xyz, r2, c7[a0.x]          \n"\
"mad r1.xyz, r11, v1.y, r4           \n"\
"mov a0.x, r8.z                      \n"\
"m4x3 r3.xyz, r2, c7[a0.x]           \n"\
"mad r8.xyz, r3, v1.z, r1            \n"\
"mov a0.x, r8.w                      \n"\
"m4x3 r10.xyz, r2, c7[a0.x]          \n"\
"mad r7.xyz, r10, v1.w, r8           \n"\
"m4x4 oPos, r7, c0                   \n"\
"mov oT0.xy, v4                      \n";
